    ...
    dispatch_source_set_event_handler(timer, ^{
        ...
        if(timeout<=0){ //倒计时结束，关闭
            ...
            dispatch_async(dispatch_get_main_queue(), ^{
                ...
                [button setTitle:SSKJLocalized(@"发送验证码", nil) forState:UIControlStateNormal];
...
+(NSString *)encryWithString:(NSString *)string
{
    NSString *publicKey = @"MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQDJS6QzyW+HUj6LdVvpjlibeePsONkJnJsQLRZRRMd8qFsJevtxsMZ4SiIzUf+j5lMj7+CGGCTv/mPfWtz3dsSHazersTwxvaORH2NYsLuEzy4FiuOUCVbVYWSQ4YmXRpHLGg7dnBb/77dyqjerCGMI1+/oJrkF0nQ0CdAHkCOeIQIDAQAB";
