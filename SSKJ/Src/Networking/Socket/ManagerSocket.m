...
- (void)webSocket:(SRWebSocket *)webSocket didReceiveMessage:(id)message{
    ...
    NSError *error;
    NSDictionary *dic = [NSJSONSerialization JSONObjectWithData:[message dataUsingEncoding:NSUTF8StringEncoding] options: NSJSONReadingMutableContainers error:&error];

    [_delegate socketDidReciveData:dic identifier:self.identifier];
